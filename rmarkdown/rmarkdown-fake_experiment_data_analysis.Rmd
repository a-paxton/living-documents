...
In this R markdown file, we'll analyze the data that we generated with our
Jupyter notebook
...
in the `jupyter_notebook-fake_experiment_data_generator.ipynb` Jupyter
notebook).
...
It looks like we've got two main effects: Using more similar amounts of negative
words and being involved in the commiseration condition are both associated with
higher rapport.
